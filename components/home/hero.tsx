    ...
    <section className="pt-20 relative isolate">
      ...
      <div className="container">
        <div className="relative aspect-[3/1] rounded-2xl">
          ...
          />
          <div className="relative top-0 left-0 w-full h-full bg-foreground/50 flex items-center justify-center p-12 rounded-2xl">
            <div className="w-full max-w-3xl text-center">
              ...
              <Button
                ...
                asChild
              >
                <Link href={"/trips/create"}>Share Your Trip</Link>
              </Button>
            </div>
