...
const AboutUs = () => {
  return (
    <article className="container space-y-12">
      <div className="flex flex-col gap-3 items-stretch relative overflow-hidden rounded-xl md:flex-row md:gap-0">
        ...
        <div className="w-full md:w-1/2 md:py-8">
          <div className="relative bg-gradient-to-t from-black/90 to-black/20 md:from-background md:to-background px-5 py-12 md:px-12 md:py-24 md:rounded-xl md:shadow-lg md:-ml-12">
            <SectionHeader
              title="Welcome to Trip Squad"
              subTitle="Your ultimate trip sharing application. Connect, explore, and share
      ...
      <section className="space-y-8">
        ...
        <div className="lg:w-4/5 mx-auto flex flex-col lg:flex-row items-stretch lg:items-center gap-10">
          <div className="lg:w-2/5 aspect-[4/3] sm:aspect-[2/1] lg:aspect-square relative h-full bg-black rounded-xl">
            <Image
