  ...
  return (
    <div className="container">
      <div className="p-6 rounded-lg bg-background">
        ...
        <p className="mb-4">
          Welcome to Trip Squad. Please read these terms and conditions
          carefully before using our service.
        </p>

        <h2 className="text-2xl font-semibold mb-2">1. Acceptance of Terms</h2>
        <p className="mb-4">
          By accessing or using the Trip Squad application, you agree to be
          bound by these terms and conditions. If you do not agree with any part
          of the terms, you may not use our service.
        </p>
        ...
        <p className="mb-4">
          ...
          and will remain the exclusive property of Trip Squad and its
          licensors. Our trademarks and trade dress may not be used in
          connection with any product or service without the prior written
          consent of Trip Squad.
        </p>
        ...
        <p className="mb-4">
          ...
          available through the service; and/or (vi) the defamatory, offensive,
          or illegal conduct of any third party. In no event shall Trip Squad be
          liable for any claim, including but not limited to, your use of the
          service, exceeding the amount paid by you to Trip Squad for the
          service.
        </p>
