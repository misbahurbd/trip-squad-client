...
const TermsAndConditions = () => {
  return (
    <div className="container p-6 rounded-lg bg-background">
      ...
      <p className="mb-4">
        Welcome to Trip Squad. Please read these terms and conditions carefully
        before using our service.
      </p>

      <h2 className="text-2xl font-semibold mb-2">1. Acceptance of Terms</h2>
      <p className="mb-4">
        By accessing or using the Trip Squad application, you agree to be bound
        by these terms and conditions. If you do not agree with any part of the
      ...
      <p className="mb-4">
        As a user, you agree to use the service only for lawful purposes and in
      ...
      <p className="mb-4">
        To use certain features of our service, you may be required to register
        an account. You agree to provide accurate and complete information and
        to keep this information up to date. You are responsible for maintaining
        the confidentiality of your account password and for all activities that
      ...
      <p className="mb-4">
        ...
        and will remain the exclusive property of Trip Squad and its licensors.
        Our trademarks and trade dress may not be used in connection with any
        product or service without the prior written consent of Trip Squad.
      </p>
      ...
      <p className="mb-4">
        In no event shall Trip Squad, nor its directors, employees, partners,
        ...
        conduct of any third party. In no event shall Trip Squad be liable for
        any claim, including but not limited to, your use of the service,
        exceeding the amount paid by you to Trip Squad for the service.
      </p>
